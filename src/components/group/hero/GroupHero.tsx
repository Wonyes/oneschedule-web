...
import { UPCOMING_RANGE_DAYS, useGroupSchedules } from "../schedule/useGroupSchedules";
...
export const GroupHero = ({ group }: { group: MyGroupResponse }) => {
  ...
  return (
    <BaseCard
      glow
      className="relative overflow-hidden p-4 sm:p-5 sm:p-4 sm:p-6"
    >
      <div
        aria-hidden
