...
export default function Header() {
  ...
  return (
    <header className="grid grid-cols-3 items-center px-8 py-4 text-slate-800">
      ...
      <div className="flex items-center gap-2 justify-end">
        <button className="flex gap-2 justify-center items-center px-4 py-2 bg-slate-50 rounded-lg border border-slate-200">
        ...
        <button className="flex gap-2 items-center bg-slate-50 border border-slate-200 rounded-lg">
          <Avatar>
            <AvatarImage src="" alt="" />
