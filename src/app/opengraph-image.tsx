...
function Glyph({ kind }: { kind: "bell" | "users" | "pin" | "check" }) {
  ...
  if (kind === "users")
    return (
      <div style={{ display: "flex", gap: 4 }}>
        <div
          style={{ width: 13, height: 13, borderRadius: 99, border: stroke }}
        />
        <div
          style={{ width: 13, height: 13, borderRadius: 99, border: stroke }}
        />
  ...
  if (kind === "pin")
    return (
      ...
      >
        <div
          style={{ width: 15, height: 15, borderRadius: 99, border: stroke }}
        />
        <div
          style={{
            width: 0,
    ...
    >
      ...
      <div
        style={{
          ...
          background: BG,
          boxShadow:
            "inset 0 14px 30px rgba(0,0,0,0.55), inset 0 1px 0 rgba(255,255,255,0.05)",
        }}
      />
      ...
      <div
        style={{
          ...
          height: 504,
          borderRadius: 9999,
          border: "2px dashed rgba(157,146,248,0.28)",
        }}
      />
      <div
        style={{
          ...
          height: 320,
          borderRadius: 9999,
          border: "2px dashed rgba(157,146,248,0.4)",
        }}
      />
      ...
      <div
        style={{
          ...
          boxShadow: `0 0 16px 4px rgba(124,108,246,0.6)`,
        }}
      />
      <div
        style={{
          ...
          borderRadius: 99,
          background: ACCENT_SOFT,
          boxShadow: `0 0 12px 3px rgba(124,108,246,0.6)`,
        }}
      />
      ...
      <div
        style={{
          ...
          boxShadow:
            "0 24px 50px rgba(124,108,246,0.5), 0 0 0 8px #111320, 0 0 0 9px rgba(255,255,255,0.05)",
          display: "flex",
          alignItems: "center",
          justifyContent: "center",
        }}
            ...
            {[0, 1, 2, 3, 4, 5].map((i) => (
              <div
                ...
                style={{
                  ...
                  height: 8,
                  borderRadius: 2,
                  background: i === 4 ? "#ffffff" : "rgba(255,255,255,0.5)",
                }}
              />
            ))}
          </div>
      ...
      {/* 위성 */}
      <Satellite cx={cx} cy={cy} angle={-95} radius={252} size={66}>
        <Glyph kind="pin" />
      </Satellite>
      <Satellite cx={cx} cy={cy} angle={40} radius={252} size={66}>
        <Glyph kind="users" />
      </Satellite>
      <Satellite cx={cx} cy={cy} angle={150} radius={252} size={66}>
        <Glyph kind="bell" />
      </Satellite>
      <Satellite cx={cx} cy={cy} angle={118} radius={160} size={54}>
        <Glyph kind="check" />
      </Satellite>
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
          ...
          >
            ONE
            <span style={{ color: MUTED, fontWeight: 500, marginLeft: 8 }}>
              SCHEDULE
            </span>
          </span>
        </div>
