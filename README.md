...
**[🌐 Live Demo](https://oneschedule.site)** &nbsp; **[📖 API 명세서](https://api.oneschedule.site/swagger-ui/index.html)** &nbsp; **[📋 PRD](docs/PRD.md)**
...
백엔드(Spring Boot)는 [별도 저장소](https://api.oneschedule.site/swagger-ui/index.html)이며, 프론트는 Vercel에 자동 배포됩니다.
...
| **기능**                                | **설명**                                                                                                  |
| :-------------------------------------- | :-------------------------------------------------------------------------------------------------------- |
| **✉️ 이메일 인증 가입 · 비밀번호 찾기** | 6자리 코드(3분 유효 · 60초 재전송 제한), 같은 인증 API를 purpose로 재사용                                 |
