...
import GroupMemberSection from "../members/GroupMemberSection";
import GroupScheduleSection from "../schedule/GroupScheduleSection";
import GroupActivitySection from "../schedule/GroupActivitySection";
import GroupAdminSection from "../admin/GroupAdminSection";
import SegmentedTabs from "../../ui/layout/SegmentedTabs";
import BaseCard from "../../ui/card/BaseCard";
import { useGroupSchedules } from "../schedule/useGroupSchedules";
    ...
    <Column className="w-full gap-5 pb-1">
      ...
      <Column className="hidden w-full gap-5 lg:flex">
        <div className="grid w-full items-start gap-5 lg:grid-cols-[minmax(0,2fr)_minmax(0,1fr)]">
          ...
          <GroupMemberSection group={group} withAdminTabs />
        </div>
      </Column>
    </Column>
  );
